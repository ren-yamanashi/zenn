---
title: "CDK Constructの依存関係を適切に管理するESLintルール"
published: true
cssclass: zenn
emoji: "📝"
type: "tech"
...
Web バックエンドエンジニアをしている[山梨](https://twitter.com/yama_ren_tw)といいます。
...
:::message
この記事で紹介する ESLint ルールは、flatConfig に対応した内容を記載しております。  
また、ESLint プラグインとして `typescript-eslint` を使用しております。
:::
...
ESLint のルールは、[no-restricted-imports](https://eslint.org/docs/latest/rules/no-restricted-imports) を使用しています。
